...
#ifndef SOFA_RGBDTRACKING_RealSenseFakeCam_H
#define SOFA_RGBDTRACKING_RealSenseFakeCam_H
...
public :
    ...
    cv::Mat read_depths () {
        return cv::imread(process_filename(depth_path, iter));
    }
    /// write rgbd
...
class RealSenseFakeCam : public virtual sofa::core::objectmodel::BaseObject {
public:
    SOFA_CLASS(SOFA_TEMPLATE(RealSenseFakeCam,DataTypes), sofa::core::objectmodel::BaseObject);
    ...
    Data<opencvplugin::ImageData> d_imageout ;
    Data<opencvplugin::ImageData> d_depthout ;
...
#if defined(SOFA_EXTERN_TEMPLATE) && !defined(RealSenseFakeCam_CPP)
#ifndef SOFA_FLOAT
extern template class SOFA_RGBDTRACKING_API RealSenseFakeCam<defaulttype::Vec3dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_RGBDTRACKING_API RealSenseFakeCam<defaulttype::Vec3fTypes>;
#endif
#endif
